...
<div class="bg4">
    <div class="top-s">
        ...
        <div class="cc" id="box">
            ...
            <div class="box">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sequi magni ratione tenetur facere minus quo architecto. Ratione, dolorem quidem voluptatibus cupiditate eos voluptates, rerum quasi unde necessitatibus molestiae alias ipsa obcaecati autem cum perferendis ab quis ea nobis. Fugit, deleniti.</p>
                <h5>Morbi sodales</h5>
            </div>
        </div>
    </div>
