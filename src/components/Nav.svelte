...
<header>
    <nav>
        ...
        <ul class="nav-link">
            <li><a href="more#who"><span>who</span></a></li>
            <li> <a href="more#what"><span>what</span></a></li>
            <li><a href="more#where"><span>where</span></a></li>
            <li><a href="more#work"><span>work</span></a></li>
