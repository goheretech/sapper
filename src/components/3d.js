...
export default class Index{
    constructor(){
        // console.log('constructor working');
            ...
            let colors = [
                ...
                new THREE.Color(
                    'hsl(' + parseInt(Math.random() * 250) + ', 50%, 70%)'
                ),
                new THREE.Color(
                    'hsl(' + parseInt(Math.random() * 250) + ', 100%, 90%)'
                )
            ];
    ...
    `;
            ...
            var sunPosition = { x: 43700, y: 0, z: 50000 }; //start
            ...
            function genSun() {
                ...
                sun = new THREE.PointLight(0xeee4f5, 1.1, 1500000, 1);
